            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                ...
                @foreach($pages as $page)
                    <div class="{{ $page->lang === 'bangla' ? 'font-bangla' : '' }} bg-white p-5 md:p-7 rounded-md">
                        ...
                        <a href="{{ route('page', ['page_slug' => $page->slug]) }}" class="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-white text-sky-900 rounded-lg focus:ring-4 focus:ring-blue-300">
