        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
            ...
            @foreach($pages as $page)
                <div class="{{ $page->lang === 'bangla' ? 'font-bangla' : '' }} bg-white p-5 md:p-7 rounded-md">
                    <h1 class="mb-4 text-2xl text-transparent md:text-3xl bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400  leading-normal tracking-normal">{{ $page->name }}</h1>
