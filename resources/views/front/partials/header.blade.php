    ...
    <div class="container mx-auto">
        <nav class="flex items-center h-16 justify-between">
            ...
            <div class="ml-auto block lg:hidden flex items-center justify-center">
                <button @click="isNavigationOpen = !isNavigationOpen" x-show="!isNavigationOpen" class="text-white">
            ...
            <div class="ml-3">
                ...
                <div id="dropdownDots" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownMenuIconButton">
                        <li>
                            <a href="https://student.uchakhilahss.edu.bd" target="_blank" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Student List</a>
                        </li>
                        <li>
