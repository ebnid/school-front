<div>
    <div class="rounded-md bg-white p-5 md:p-10">
        ...
        <div class="grid grid-cols-1 gap-4">
            ...
            <div class="col-span-2">
                ...
                <x-input wire:model.debounce="order" id="slug" class="block mt-1 h-8 w-full" type="number" required />
            </div>
    ...
    <div class="rounded-md bg-white p-5 md:p-10 md:mt-5">
        <h1 class="font-bold text-xl mb-4">Notice Content</h1>
        ...
        <div class="flex items-center justify-end mt-8">
            ...
            @else
                <x-button wire:click.debounce="createNotice" class="ml-4">
                    {{ __('Create') }}
                </x-button>
            @endif
        </div>
    ...
    <x-ui.loading-spinner wire:loading.flex wire:target="cancelEditMode, createNotice, updateNotice, contents, removeAllContents, removeContentOf, removeExistingContentOf" />
</div>
